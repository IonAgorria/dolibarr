...
?>
	...
	if (! empty($conf->product->enabled) || ! empty($conf->service->enabled))
	{
		...
		echo '<input type="hidden" id="duration_value" name="duration_value" value="">';
		...
		{
			$ajaxoptions=array(
					'update' => array('duration_unit' => 'duration_unit', 'duration_value' => 'duration_value', 'seltype' => 'type'),	// html id tags that will be edited with which ajax json response key
			);
		...
		{
			$ajaxoptions=array(
					'update' => array('duration_unit' => 'duration_unit', 'duration_value' => 'duration_value', 'seltype' => 'type', 'qty'=>'qty','remise_percent' => 'discount','idprod' => 'idprod'),	// html id tags that will be edited with which ajax json response key
